...
const AVAILABLE_ROUTES: RouteOption[] = [
  {
    id: "va-bbs",
    name: {
      en: "Village A (Pipili Rural Cluster) → Bhubaneswar Central Hub",
      hi: "ग्राम A (पिपिली ग्रामीण क्लस्टर) → भुवनेश्वर सेंट्रल हब",
      or: "ଗ୍ରାମ A (ପିପିଲି ଗ୍ରାମୀଣ କ୍ଲଷ୍ଟର) → ଭୁବନେଶ୍ୱର ସେଣ୍ଟ୍ରାଲ୍ ହବ୍",
    },
    distanceKm: 20,
    baseCost: 850,
    roadHours: 0.6,
  ...
  },
  {
    id: "vb-bbs",
    name: {
      en: "Village B (Khordha Dairy Cluster) → Bhubaneswar Cold Hub",
      hi: "ग्राम B (खोरधा डेरी क्लस्टर) → भुवनेश्वर कोल्ड हब",
      or: "ଗ୍ରାମ B (ଖୋର୍ଦ୍ଧା ଦୁଗ୍ଧ କ୍ଲଷ୍ଟର) → ଭୁବନେଶ୍ୱର କୋଲ୍ଡ ହବ୍",
    },
    distanceKm: 25,
    baseCost: 1100,
    roadHours: 0.7,
  ...
  },
  {
    id: "vc-ctc",
    name: {
      en: "Village C (Nimapada Agro Belt) → Cuttack Terminal",
      hi: "ग्राम C (निमापड़ा कृषि बेल्ट) → कटक टर्मिनल",
      or: "ଗ୍ରାମ C (ନିମାପଡ଼ା କୃଷି ବଳୟ) → କଟକ ଟର୍ମିନାଲ୍",
    },
    distanceKm: 38,
    baseCost: 1400,
    roadHours: 1.2,
  ...
  },
  {
    id: "vd-ctc",
    name: {
      en: "Village D (Banki Riverine Farms) → Cuttack Crossdock",
      hi: "ग्राम D (बांकी नदी तटीय फार्म) → कटक क्रॉसडॉक",
      or: "ଗ୍ରାମ D (ବାଙ୍କୀ ନଦୀ କୂଳ ଫାର୍ମ) → କଟକ କ୍ରସଡକ୍",
    },
    distanceKm: 42,
    baseCost: 1600,
    roadHours: 1.8,
  ...
  },
  {
    id: "puri-bbs",
    name: {
      en: "Puri Coastal Depot → Bhubaneswar Central Hub",
      hi: "पुरी तटीय डिपो → भुवनेश्वर सेंट्रल हब",
      or: "ପୁରୀ ଉପକୂଳ ଡିପୋ → ଭୁବନେଶ୍ୱର ସେଣ୍ଟ୍ରାଲ୍ ହବ୍",
    },
    distanceKm: 60,
    baseCost: 2200,
    roadHours: 1.2,
