...
export function AiBrainIcon({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-2.5 2.5h-1A4.5 4.5 0 0 1 4 17.5V17a3 3 0 0 1-1.5-2.6 3 3 0 0 1 1.2-2.4A4 4 0 0 1 3 9a4 4 0 0 1 4-4h2.5Z" />
      <path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 2.5 2.5h1A4.5 4.5 0 0 0 20 17.5V17a3 3 0 0 0 1.5-2.6 3 3 0 0 0-1.2-2.4A4 4 0 0 0 21 9a4 4 0 0 0-4-4h-2.5Z" />
      <path d="M12 7.5h2.5" />
      <path d="M12 12h3" />
      <path d="M12 16.5h2" />
      <path d="M9.5 7.5H12" />
...
export function RefreshIcon({
  ...
  return (
    ...
    >
      <path d="M21.5 2v6h-6" />
      <path d="M21.34 15.57a10 10 0 1 1-.57-8.38l.73-.19" />
    </svg>
  );
}
...
export function TrainIcon({
  ...
  return (
    ...
    >
      ...
      <path d="m8 18-3 3M16 18l3 3M9 3v8M15 3v8" />
    </svg>
  );
}
